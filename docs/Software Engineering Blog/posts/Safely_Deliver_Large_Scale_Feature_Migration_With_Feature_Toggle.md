...
if there is no problem, then increase to 50%, 75%, 100%. (get more detail about performing canary release by feature toggles in my [previous article](/Software%20Engineering%20Blog/2023/09/28/easier-flexible-and-lower-resource-cost-deployment-strategies-by-feature-toggle))
